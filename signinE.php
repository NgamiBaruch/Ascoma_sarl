...
<body>
    <form action="../Baskend/EntrepriseInscription.php" method="post">
            ...
            <div class="logo">
             ...
             <div class="information">
                 <div class="input">
                     ...
                     <div class="inputname">
                        <div class="nomsE">
                            <input type="text" name="nomE" class="prenoms">
                        ...
                        <div class="villesE">
                            <input type="text" name="villeE" class="noms">
                            <label for="lastname">ville(s) ou se trouvent l'entreprise</label>
                            <div class="message2">
                                !Veuillez remplir ce champ
                             </div>
                        </div>
